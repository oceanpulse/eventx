...
import { mainnet, hardhat, avalancheFuji } from 'wagmi/chains' //add chains here
...
const AvalancheFuji: Chain = {
  ...
  network: 'fuji',
  iconUrl: 'https://avalanche.network/logo.png',
  iconBackground: '#000000',
  nativeCurrency: {
    decimals: 18,
    name: 'Avalanche',
...
const { chains, publicClient } = configureChains(
  [mainnet, hardhat, avalancheFuji], //add chains here
